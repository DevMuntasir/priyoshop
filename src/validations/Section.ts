...
const headingSchema = z.object({
  ...
  backgroundImageTablet: z.string().max(300).optional(),
  backgroundImageLaptop: z.string().max(300).optional(),
  backgroundImageDesktop: z.string().max(300).optional(),
...
const itemSchema = z.object({
  ...
  slideBackgroundImageTablet: z.string().max(300).optional(),
  slideBackgroundImageLaptop: z.string().max(300).optional(),
