...
import { slugifyTitle, validateBlogSlug } from '@/libs/media/blogSlug';
...
export default function NewBlogPostPage() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      router.push(`/admin/media/${data.post.postId}`);
    } catch (err) {
        ...
        <Stack gap="md">
          <div>
            ...
            <Input
              ...
              placeholder="e.g., Why branding is more than just a logo"
              disabled={isLoading}
            />
          </div>
