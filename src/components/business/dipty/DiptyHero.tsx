        ...
        >
          <div className="max-w-[400px] lg:max-w-[700px]">
            <Reveal direction="right" delay={0}>
              <h1
                className={`max-w-[300px] font-display text-balance font-extrabold leading-[1.2] lg:max-w-full ${
                  resolved.titleSizeClass || 'text-ps-h3 sm:text-ps-h2 lg:text-ps-h1 xl:text-ps-display'
