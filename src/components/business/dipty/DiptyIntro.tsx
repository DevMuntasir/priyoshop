  ...
  return (
    <section className="relative w-full  ">
      <div className="min-h-[45svh]  bg-[url(/dipty/about.png)] bg-cover bg-center bg-no-repeat lg:min-h-[90dvh]">
        <div className="min-h-[45svh]lg:min-h-[90dvh] bg-gradient-to-r md:from-transparent md:via-transparent md:to-transparent  from-white via-white to-white/50 lg:min-h-[90dvh]">
