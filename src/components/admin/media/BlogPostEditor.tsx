      ...
      <div className='px-8 space-y-4'>
        ...
        <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
          ...
          <Card padding="lg" className="space-y-5 self-start">
            ...
            <Field label="Cover image" hint="Path or URL, e.g. /blogs/1.png">
              <Input
                type="text"
              ...
              {post.coverImage && (
                ...
                <img
                  src={post.coverImage}
                  alt={post.coverImageAlt ?? 'Cover preview'}
                  className="mt-2 aspect-video w-full rounded-ps-sm object-cover"
                />
              )}
            </Field>
