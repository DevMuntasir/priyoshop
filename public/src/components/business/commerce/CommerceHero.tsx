...
export function CommerceHero(props: { data: ResolvedSection }) {
  ...
  return (
    <section className="flex min-h-[100svh] flex-col justify-center bg-ps-cream pt-28 pb-12 lg:min-h-[100dvh] lg:pt-32">
      <div className="container mx-auto flex min-h-[60svh] flex-col justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-[500px]">
          <h1
            className={`font-display font-extrabold leading-[1.3] text-balance text-ps-h3 sm:text-ps-h2 lg:text-ps-h1 xl:text-ps-display`}
          >
