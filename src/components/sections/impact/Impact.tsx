      ...
      <div className="relative mx-auto h-full max-w-[1400px] px-4 sm:px-6 lg:min-h-full lg:content-center lg:px-12">
        ...
        <div
          className="
            ...
            lg:right-4 lg:w-[52%] lg:max-w-[720px] lg:-translate-y-1/2
          "
        >
          ...
          <div className="absolute top-[5.5%] left-[10.5%] z-10 w-[57%]">
            <Image
          ...
          <div className="absolute top-0 right-0 z-10 w-[36%]">
            <Image
          ...
          <div className="absolute top-[45%] right-[31%] z-10 w-[50%]">
            <Image
          ...
          <div className="absolute top-[33.5%] right-0 z-10 w-[36%]">
            <Image
          ...
          <div className="absolute right-[32%] -bottom-12 z-10 w-[75%]">
            <Image
