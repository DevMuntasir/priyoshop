...
export default function SnakeTimeline({ config, heading, style }: { config: SnakeTimelineConfig, heading: any, items: any, style: any }) {
  const {
    items,
    columns,
    accentColor,
  ...
  return (
    <section ref={trackRef} style={{ height: `${scrollVh}vh` }} className="relative w-full">
      <div className="sticky md:top-[150px] top-[100px] flex flex-col w-full items-center justify-center px-4">
