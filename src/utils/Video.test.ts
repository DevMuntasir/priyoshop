...
describe('Video utility', () => {
  describe('extractYouTubeId utility', () => {
    ...
    it('extracts ID from shorts and live URLs', () => {
      expect(extractYouTubeId('https://www.youtube.com/shorts/0B2MieWr4rE')).toBe('0B2MieWr4rE');
      expect(extractYouTubeId('https://www.youtube.com/live/0B2MieWr4rE')).toBe('0B2MieWr4rE');
    });
  ...
  describe('parseVideoSource utility', () => {
    it('parses YouTube link into structured youtube object', () => {
      ...
      expect(parsed).toStrictEqual({
        type: 'youtube',
        videoId: '0B2MieWr4rE',
        embedUrl: 'https://www.youtube-nocookie.com/embed/0B2MieWr4rE',
        thumbnailUrl: 'https://img.youtube.com/vi/0B2MieWr4rE/hqdefault.jpg',
      });
    });
    ...
    it('falls back to default video on null or empty input', () => {
      expect(parseVideoSource(null)).toStrictEqual({
        type: 'direct',
        src: '/video/1.mp4',
      });
    });
